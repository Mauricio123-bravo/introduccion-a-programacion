...
//DESCRIPTION: generate the price radomly (1000 to 99000) for N products and save them in a vector
//DATE: 3-11-20
...
public class App {
    ...
    public static void f_introduction() {
        ...
        System.out.println("vectoragewithpriceSOFT-----version 1.0-----made by Mauricio Bravo");
