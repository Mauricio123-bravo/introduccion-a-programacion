...
//DESCRIPTION: a program in java tha allowa storing the salaries of the employees grouped by shift
//DATE: 29-10-20
...
public class App {
    ...
    public static void f_introduction() {
        ...
        System.out.println("vectorswith salaryandtwoturnsSOFT------version 1.0-----made by Mauricio Bravo");
