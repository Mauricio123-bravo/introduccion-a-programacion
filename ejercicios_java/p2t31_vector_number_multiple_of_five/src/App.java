...
//DESCRIPTION: this program calculate vector number multiple of five
//DATE: 5-11-20
...
public class App {
    ...
    public static void f_introduction() {
        ...
        System.out.println("vectornumbermultipleSOFT-----version 1.0------made by Mauricio Bravo");
    ...
    public static int f_total_numbers() {
        ...
        int v_total_number = keyboard.nextInt();
        ...
        v_total_number= keyboard.nextInt();
