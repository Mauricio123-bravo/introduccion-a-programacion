...
public class App {
    ...
    public static void f_menu(){
        ...
        System.out.println("drinksmachineSOFT-------VERSION 1.0-----made by Mauricio Bravo");
    }
    ...
    public static void f__coffee_with_milk(){
    ...
    public static void f__cappuccino(){
    ...
    public static void f__Mochaccino(){
